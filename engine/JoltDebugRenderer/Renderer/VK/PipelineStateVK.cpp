...
PipelineStateVK::PipelineStateVK(RendererVK* inRenderer, const VertexShaderVK* inVertexShader,
                                 ...
                                 ETopology inTopology, EDepthTest inDepthTest, EBlendMode inBlendMode, ECullMode inCullMode)
    : mRenderer(inRenderer), mVertexShader(inVertexShader), mPixelShader(inPixelShader)
{
    ...
    FatalErrorIfFailed(
        vkCreateGraphicsPipelines(mRenderer->GetDevice(), VK_NULL_HANDLE, 1, &pipeline_info, nullptr, &mGraphicsPipeline));
}
