...
Font::Font(RendererJPH* inRenderer) : mRenderer(inRenderer) {}
...
try_again:;
    ...
    // Trace success
    Trace("Created font \"%s\" with height %d in a %dx%d surface", mFontName.c_str(), mCharHeight, mHorizontalTexels,
          mVerticalTexels);
...
bool Font::CreateString(Mat44Arg inTransform, const string_view& inText, ColorArg inColor,
